...
// default access code value for account updates
if (window.location.href.indexOf("account_details") > -1) {
    const accessCodeField = document.getElementById('FormField_27');
    const accessCodeInput = document.getElementById('FormField_27_input');
    accessCodeField.style.display = 'none';
    accessCodeInput.setAttribute('aria-required', false);
    accessCodeInput.value = "maloufuser";
}
